...
module.exports = function inject () {
  ...
  class GenericIARewritter {
    ...
    rewriteURL (url, mod) {
      ...
      if (this.shouldIgnore(url) || this.isIAInternal(url)) {
        return url
      }
    ...
    overrides () {
      ...
      if (window.Element && window.Element.prototype) {
        ...
        window.Element.prototype.getAttribute = function getAttribute (prop) {
          ...
          if (
            propNameLower.indexOf('data-') === 0 &&
            rewriter.isRewritableWSchemeless(result)
          ) {
            return rewriter.doRewrite(
              result,
              modifiers ? modifiers[propNameLower] : modifiers
            )
          } else if (modifiers) {
      ...
      if (window.HTMLElement && window.HTMLElement.prototype) {
        ...
        if (osetINNERHTML) {
          ...
          rewriter.defineProperty2(
            ...
            'innerHTML',
            function () {
              return ogetINNERHTML.call(this)
            },
            function (htmlString) {
              if (!this._no_rewrite) {
                if (this.tagName === 'STYLE') {
        ...
        if (osetOUTERHTML) {
          ...
          rewriter.defineProperty2(
            ...
            'outerHTML',
            function () {
              return ogetOUTERHTML.call(this)
            },
            function (htmlString) {
              if (!this._no_rewrite) {
                if (this.tagName === 'STYLE') {
    ...
    rewriteHTML (string, needsEnd) {
      ...
      if (this.isFullHTML(string)) return this.rewriteFullHTML(string, needsEnd)
